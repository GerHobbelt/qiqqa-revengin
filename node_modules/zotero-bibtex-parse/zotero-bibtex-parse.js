	...
	function BibtexParser() {
		...
		this.match = function(s, canCommentOut) {
			...
			if (this.input.substring(this.pos, this.pos + s.length) == s) {
				...
				throw "Token mismatch, expected " + JSON.stringify(s) + " at index " + this.pos + ", found "
						+ JSON.stringify(this.input.substr(this.pos, s.length + 12 /* arbitrary clipping heuristic */ ));
			};
			this.skipWhitespace(canCommentOut);
		};
		...
		this.key = function() {
			...
			while (true) {
				...
				if (this.input[this.pos].match("[a-zA-Z0-9+_:\\?\\./-]")) { // Added question marks to handle Zotero going sideways. -APCS
					...
					// BibTeX keys are case-*IN*sensitive; we always produce the uppercase flavour:
